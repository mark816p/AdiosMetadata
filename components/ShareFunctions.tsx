...
const ShareFunctions = () => {
  ...
  const handleBookmark = () => {
    if (typeof window !== "undefined" && "bookmark" in navigator === false) {
    ...
    <div className="w-full flex flex-col gap-(--fluid-lg-2xl) text-lg">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-(--space-md)">
        ...
        <div className="grid grid-cols-4 gap-(--space-md)">
          <Button
            size="lg"
            className="sm:min-w-20 type-fluid type-button bg-background hover:bg-muted/50 text-foreground border-foreground border-2"
          ...
          >
            ...
            <p className="hidden md:inline">Reddit</p>
          </Button>
          <Button
            size="lg"
            className="type-fluid type-button bg-background hover:bg-muted/50 text-foreground border-foreground border-2"
